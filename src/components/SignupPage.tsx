...
const SignupPage: React.FC = () => {
  ...
  return (
    <div className="max-w-md mx-auto py-12">
      ...
      >
        <h2 className="text-3xl font-serif font-bold text-stone-900 mb-2 text-center">Create Account</h2>
        <p className="text-stone-500 text-center mb-8">Start your personal journal today.</p>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div>
            ...
            <p className="mt-1.5 ml-1 text-xs text-stone-400">Must be at least 6 characters long.</p>
          </div>
          <button
            type="submit"
